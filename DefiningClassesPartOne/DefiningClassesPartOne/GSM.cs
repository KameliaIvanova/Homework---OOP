    ...
    public class GSM
    {
        ...
        public string Model
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(string.Format("Invalid phone model! Model length have to be between {0} and {1} characters", MIN_MODEL_LENGTH, MAX_MODEL_LENGTH));
                }
            }
        }
        ...
        public string Manufacturer
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(string.Format("Invalid manufacturer! Manufacturer length have to be between {0} and {1} characters", MIN_MANUFACTURER_LENGTH, MAX_MANUFACTURER_LENGTH));
                }
            }
        }
